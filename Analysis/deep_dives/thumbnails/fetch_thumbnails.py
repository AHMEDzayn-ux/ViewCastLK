...
Usage:
    python Analysis/deep_dives/thumbnails/fetch_thumbnails.py --limit 500            # try it
    python Analysis/deep_dives/thumbnails/fetch_thumbnails.py --max-age-days 21      # the real run
"""
import argparse
import io
import os
