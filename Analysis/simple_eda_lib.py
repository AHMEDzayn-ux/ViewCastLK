"""Helpers for simple_eda.ipynb: every chart in that notebook is drawn from here.
...
Figures are shown inline and also saved to eda_figures/simple_eda/.
"""
import os
import warnings
...
OUT = os.path.join(HERE, "eda_figures", "simple_eda")
